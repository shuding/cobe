...
export function Cobe() {
  ...
  useEffect(() => {
    ...
    const globe = createGlobe(canvasRef.current, {
      ...
      // Disable dragging and auto-rotation
      dragX: false,
      dragY: false,
      autoRotateSpeed: 0,
...
[View source of this example on GitHub](https://github.com/shuding/cobe/blob/main/website/pages/docs/showcases/rotate-to-location.mdx?plain=1)
